...
- **Variantes** (taille, couleur, pointure… 5 groupes max) avec supplément de prix par valeur (« XL +5 ») ; **quantité − / +** et **total calculé en direct** dans le formulaire. Le serveur recalcule toujours le montant (prix + suppléments) × quantité ; la variante choisie figure sur la commande.
